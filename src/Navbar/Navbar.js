...
const Navbar = ({About, Gallery, Appointments, Contact}) => {
	return(
		<div>
			<nav class="db dt-l w-100 border-box pa3 ph5-l sticky bg-black baskerville" style={{zIndex:"20"}}>
				<a class="db dtc-l v-mid mid-gray link dim w-100 w-25-l tc tl-l mb2 mb0-l" href="/homepage" title="Home">
					<img 
				...
				<div class="db dtc-l v-mid w-100 w-75-l tc tr-l">
					<a class="link dim white f5 f4-l dib mr3 mr4-l" href="/homepage" title="Home">Home</a>
