    ...
    return (
		<div className="welcome">
			<div className='welcomebg'>
				<div 
					className="fl w-25 tl mt5 mb7"
					data-aos="zoom-in" 
					data-aos-duration="2000"
				>
					<a class="link gray hover-silver dib h2 w2 ml6" href="https://facebook.com" title="Facebook">
				...
				<div className ="fl w-75 tr-ns mt5 mv5-ns f3 f1-ns"style={{fontFamily:"Mak", color:"white"}}>
					<div 
						className="mr7-ns"
						data-aos="fade-down" 
						data-aos-duration="2000" 
